...
/**
 * Description - Unit tests for FizzBuzz - Step 02.
 *
 */
public class FizzBuzzTest {
	...
	public void testValidRangeArguments() {
		...
		assertEquals("1 2 lucky 4 buzz fizz 7 8 fizz buzz 11 fizz lucky 14 fizzbuzz 16 17 fizz 19 buzz", outContent.toString());
